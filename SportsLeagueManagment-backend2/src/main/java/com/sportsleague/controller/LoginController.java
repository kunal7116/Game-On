...
import com.sportsleague.DTO.JwtAuthResponse;
import com.sportsleague.DTO.LoginDTO;
import com.sportsleague.security.JwtUtils;
...
public class LoginController {
	...
	@PostMapping("/signin")
	public ResponseEntity<?> signIn(@RequestBody @Valid LoginDTO authRequest) {
